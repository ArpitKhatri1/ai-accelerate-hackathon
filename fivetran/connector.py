...
SCHEMA_DEFINITION: List[Dict[str, Any]] = [
    {
        ...
        "description": (
            "Core envelope metadata including lifecycle timestamps, subject lines, and the"
            " overall contract status for downstream cycle-time and conversion analytics."
        ),
    },
    {
        "table": "recipients",
        ...
        "description": (
            "Primary recipient roster summarizing signer, carbon copy, and in-person roles"
            " with the latest routing order, status, and contact information per envelope."
        ),
    },
    {
        ...
        "primary_key": ["envelope_id", "recipient_id"],
        "description": (
            "Extended recipient history capturing reminder activity, decline reasons, and"
            " key milestone timestamps to support SLA and escalation tracking."
        ),
    },
    {
        "table": "audit_events",
        ...
        "description": (
            "Detailed DocuSign audit log events flattened from the platform logs to power"
            " compliance reporting, workflow debugging, and anomaly detection."
        ),
    },
    {
        ...
        "description": (
            "Reminder and expiration notifications issued for an envelope, including"
            " scheduling metadata for understanding automated outreach cadence."
        ),
    },
    {
        "table": "documents",
        ...
        "description": (
            "Envelope document catalog describing each file, its DocuSign type, name, and"
            " page counts for usage and compliance dashboards."
        ),
    },
    {
        ...
        "primary_key": ["envelope_id", "document_id"],
        "description": (
            "Base64-encoded source payload for every document, enabling downstream legal"
...

    {
        ...
        "description": (
            "Template registry for reusable envelope blueprints including creation,"
            " modification, and sharing details to monitor template governance."
        ),
    },
    {
        "table": "custom_fields",
        ...
        "description": (
            "Envelope-level custom fields and list selections promoting granular deal,"
            " transaction, or regional segmentation inside analytics models."
        ),
    },
]
...
def update(configuration: dict, state: Dict[str, Any]):
    ...
    access_token = _refresh_access_token(configuration)
    logger.info(f"Access token obtained successfully {_mask_token(access_token)}")
